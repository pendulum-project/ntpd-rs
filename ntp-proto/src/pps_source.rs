...
#[cfg(test)]
mod test {
    use crate::time_types::{NtpDuration, NtpInstant, NtpTimestamp};
    ...
    fn test_handle_rate_limiting() {
        ...
        assert_eq!(
            ...
            source
                .last_poll_interval
                .inc(source.source_defaults_config.poll_interval_limits)
        );
    }
    ...
    fn test_measurement_from_gps() {
        ...
        let measurement =
            Measurement::from_gps(offset, local_clock_time, timestamp, measurement_noise);
        ...
        assert_eq!(
            ...
            NtpDuration::from_seconds(measurement_noise)
        );
    }
    ...
    fn test_measurement_from_pps() {
        ...
        let measurement =
            Measurement::from_pps(offset, local_clock_time, ntp_timestamp, measurement_noise);
        ...
        assert_eq!(
            pps_measurement.measurementnoise,
            NtpDuration::from_seconds(measurement_noise)
        );
    }
}
