...
{
    fn update(&mut self, measurement: Measurement<D>) {
    ...
    SourceFilter<D, N>
{
    ...
    fn absorb_measurement(&mut self, measurement: Measurement<D>) -> (f64, f64, f64) {
    ...
    SourceState<D, N>
{
    ...
    pub fn update_self_using_measurement(
        ...
        self.update_self_using_raw_measurement(source_config, algo_config, measurement)
    }
            ...
            SourceStateInner::Stable(filter) => {
                    ...
                    > algo_config.meddling_threshold
                {
                    ...
                    *self = SourceState(SourceStateInner::Initial(InitialSourceFilter {
                    ...
                    filter.update(source_config, algo_config, measurement)
                }
            }
        }
    }
