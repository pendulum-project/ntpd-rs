...
| allowlist.filter         | ["0.0.0.0/0", "::/0"] | List of IP subnets allowed to contact through this interface.                                                                                                                                                          |
...
| denylist.filter          | []                    | List of IP subnets disallowed to contact through this interface.                                                                                                                                                       |
...
| listen                  |         | Address of the interface to bind to for the NTS-KE server.                                                                                                                                   |
