...
mod tests {
    ...
    fn timestamp_wireformat() {
        let representations = [(
            [
                0x10, 0x02, 0x00, 0x2c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x63, 0xff, 0xff, 0x00, 0x09, 0xba,
                0x00, 0x01, 0x00, 0x74, 0x00, 0x00, 0x00, 0x00, 0x45, 0xb1, 0x11, 0x5a, 0x0a, 0x64,
                0xfa, 0xb0,
            ],
            SyncMessage {
                header: Header {
        ...
        for (byte_representation, object_representation) in representations {
            ...
            let deserialized_data = SyncMessage::deserialize(&byte_representation).unwrap().0;
